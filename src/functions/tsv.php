...
function import_tsv_string($tsv_str, $convertToUTF8=false, $returnHeaderOnly = false, $stripComments = true, $delimiter="\t"){
    ...
    $tsv = parse_tsv(trim($tsv_str), $delimiter, true, true, $stripComments);
...
function parse_tsv ($tsv_string, $delimiter = ",", $skip_empty_lines = true, $trim_fields = true, $stripComments = true){
